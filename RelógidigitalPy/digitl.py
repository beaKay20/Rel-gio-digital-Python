...
lb_hr = Label(clk, text="12", font=("Times", 70, 'bold'), bg="#087587", fg="white")
lb_hr.place(x=350, y=200, width=150, height=150)

lb_mn = Label(clk, text="12", font=("Times", 70, 'bold'), bg="#008EA4", fg="white")
lb_mn.place(x=520, y=200, width=150, height=150)

lb_sc = Label(clk, text="12", font=("Times", 70, 'bold'), bg="#068488", fg="white")
lb_sc.place(x=690, y=200, width=150, height=150)

lb_dn = Label(clk, text="AM", font=("Times", 70, 'bold'), bg="#9f0646", fg="white")
...
lb_hr_txt = Label(clk, text="Horas", font=("Times", 20, "bold"), bg="#087587", fg="white")
lb_hr_txt.place(x=350, y=360, width=150, height=50)

lb_mn_txt = Label(clk, text="Minutos", font=("Times", 20, "bold"), bg="#008EA4", fg="white")
lb_mn_txt.place(x=520, y=360, width=150, height=50)

lb_sc_txt = Label(clk, text="Segundos", font=("Times", 20, "bold"), bg="#068488", fg="white")
lb_sc_txt.place(x=690, y=360, width=150, height=50)

lb_dn_txt = Label(clk, text="NOON", font=("Times", 20, "bold"), bg="#9f0646", fg="white")
